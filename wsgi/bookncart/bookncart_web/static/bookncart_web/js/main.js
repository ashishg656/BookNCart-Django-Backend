...
$(document).ready(function () {
    ...
    setCarouselHeightTo60();  // for carousel height
    setCarouselSlickInitialise();  // for carusel slides init
...
$(window).bind('resizeEnd', function () {
    ...
    if (heightChanged > 90 || heightChanged < -90) {
        setCarouselHeightTo60();
    }
...
function setCarouselHeightTo60() {
    var height_60 = ($(window).height()) * 0.6;
    $(".60_percent_height_javascript").css("height", height_60);
}

function setCarouselSlickInitialise() {
...
function navbarBackgroundTransparencyHide() {
    $("#navbar_pc").removeClass("navbarTransparentbackground");
...
function navbarBackgroundTransparencyShow() {
    $("#navbar_pc").addClass("navbarTransparentbackground");
